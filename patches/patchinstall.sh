...
# | 	include/winternl.h
# |
if [ "$enable_ws2_32_WriteWatches" -eq 1 ]; then
...
# |
if [ "$enable_Miscellaneous" -eq 1 ]; then
...
# |   *	dlls/atl/atl_ax.c
# |
if [ "$enable_atl_IOCS_Property" -eq 1 ]; then
...
# | 	include/commctrl.h
# |
if [ "$enable_comctl32_LoadIconMetric" -eq 1 ]; then
...
# |   *	configure.ac
# |
if [ "$enable_configure_Absolute_RPATH" -eq 1 ]; then
...
# |   *	dlls/d3d9/surface.c
# |
if [ "$enable_d3d9_Surface_Refcount" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_ConvertToIndexedBlended" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_D3DXStubs" -eq 1 ]; then
...
# |
if [ "$enable_wined3d_DXTn" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_DrawText" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_Filter_Warnings" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_FindNextValidTechnique" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_GetShaderSemantics" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_Optimize_Inplace" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_Texture_Align" -eq 1 ]; then
...
# |
if [ "$enable_d3dx9_36_UpdateSkinnedMesh" -eq 1 ]; then
...
# |
if [ "$enable_dbghelp_Debug_Symbols" -eq 1 ]; then
...
# |
if [ "$enable_dbghelp_KdHelp" -eq 1 ]; then
...
# |
if [ "$enable_ddraw_d3d_execute_buffer" -eq 1 ]; then
...
# |
if [ "$enable_dinput_Events" -eq 1 ]; then
...
# |
if [ "$enable_dsound_Fast_Mixer" -eq 1 ]; then
...
# |   *	dlls/dxgi/output.c
# |
if [ "$enable_dxgi_GetDesc" -eq 1 ]; then
...
# |
if [ "$enable_fonts_Missing_Fonts" -eq 1 ]; then
...
# |
if [ "$enable_gdi32_MaxPixelFormats" -eq 1 ]; then
...
# |
if [ "$enable_gdi32_MultiMonitor" -eq 1 ]; then
...
# |
if [ "$enable_gdiplus_GdipCreateRegionRgnData" -eq 1 ]; then
...
# |
if [ "$enable_imagehlp_BindImageEx" -eq 1 ]; then
...
# |
if [ "$enable_imm32_Cross_Thread_Access" -eq 1 ]; then
...
# |   *	include/wine/test.h
# |
if [ "$enable_include_Winetest" -eq 1 ]; then
...
# |
if [ "$enable_iphlpapi_TCP_Table" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_Console_Handles" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_GetFinalPathNameByHandle" -eq 1 ]; then
...
# | 	include/winbase.h
# |
if [ "$enable_kernel32_GetNumaProcessorNode" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_GetStringTypeW" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_GetSystemTimes" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_GetVolumePathName" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_Named_Pipe" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_NeedCurrentDirectoryForExePath" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_Profile" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_UTF7_Support" -eq 1 ]; then
...
# |
if [ "$enable_kernel32_VerifyVersionInfo" -eq 1 ]; then
...
# |
if [ "$enable_libs_Unicode_Collation" -eq 1 ]; then
...
# |   *	tools/makedep.c
# |
if [ "$enable_makedep_PARENTSPEC" -eq 1 ]; then
...
# |
if [ "$enable_msvcp90_basic_string_wchar_dtor" -eq 1 ]; then
...
# |
if [ "$enable_msvcrt_atof_strtod" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_DOS_Attributes" -eq 1 ]; then
...
# |   *	dlls/ntdll/cdrom.c
# |
if [ "$enable_ntdll_DVD_Read_Size" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_DllRedirects" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_Dynamic_DST" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_Exception" -eq 1 ]; then
...
# |   *	dlls/ntdll/server.c
# |
if [ "$enable_ntdll_FD_Cache" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_FileDispositionInformation" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_Fix_Alignment" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_Fix_Free" -eq 1 ]; then
...
# |   *	dlls/ntdll/heap.c
# |
if [ "$enable_ntdll_Heap_FreeLists" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_LZNT1_Compression" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_NtQuerySection" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_NtSetLdtEntries" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_Pipe_SpecialCharacters" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_RtlIpv4StringToAddressExA" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_ThreadTime" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_User_Shared_Data" -eq 1 ]; then
...
# |
if [ "$enable_ntdll_WinSqm" -eq 1 ]; then
...
# |
if [ "$enable_ntoskrnl_Irp_Status" -eq 1 ]; then
...
# |   *	dlls/ntoskrnl.exe/ntoskrnl.c
# |
if [ "$enable_ntoskrnl_Stub_FileObject" -eq 1 ]; then
...
# |
if [ "$enable_nvcuda_CUDA_Support" -eq 1 ]; then
...
# |
if [ "$enable_ole32_CoWaitForMultipleHandles" -eq 1 ]; then
...
# |
if [ "$enable_quartz_MediaSeeking_Positions" -eq 1 ]; then
...
# |
if [ "$enable_riched20_IText_Interface" -eq 1 ]; then
...
# |
if [ "$enable_secur32_Schannel_ContextAttr" -eq 1 ]; then
...
# |
if [ "$enable_server_Address_Change_Notification" -eq 1 ]; then
...
# |
if [ "$enable_server_CreateProcess_ACLs" -eq 1 ]; then
...
# |
if [ "$enable_server_Misc_ACL" -eq 1 ]; then
...
# |
if [ "$enable_server_OpenProcess" -eq 1 ]; then
...
# |
if [ "$enable_server_Unexpected_Wakeup" -eq 1 ]; then
...
# |
if [ "$enable_setupapi_SetupPromptForDisk" -eq 1 ]; then
...
# |
if [ "$enable_shdocvw_ParseURLFromOutsideSource_Tests" -eq 1 ]; then
...
# |
if [ "$enable_shell32_Default_Folder_ACLs" -eq 1 ]; then
...
# |
if [ "$enable_shell32_Default_Path" -eq 1 ]; then
...
# |
if [ "$enable_shell32_Icons" -eq 1 ]; then
...
# |
if [ "$enable_shell32_RunDLL_CallEntry16" -eq 1 ]; then
...
# |
if [ "$enable_shell32_SHCreateSessionKey" -eq 1 ]; then
...
# |
if [ "$enable_shell32_SHFileOperation" -eq 1 ]; then
...
# |   *	dlls/shlwapi/path.c
# |
if [ "$enable_shlwapi_PathIsDirectoryEmptyW" -eq 1 ]; then
...
# |
if [ "$enable_shlwapi_UrlCombine" -eq 1 ]; then
...
# |
if [ "$enable_slc_SLGetWindowsInformation" -eq 1 ]; then
...
# |
if [ "$enable_urlmon_CoInternetSetFeatureEnabled" -eq 1 ]; then
...
# |
if [ "$enable_user32_Dialog_Paint_Event" -eq 1 ]; then
...
# |   *	dlls/user32/text.c
# |
if [ "$enable_user32_DrawTextExW" -eq 1 ]; then
...
# |   *	dlls/user32/input.c
# |
if [ "$enable_user32_GetRawInputDeviceList" -eq 1 ]; then
...
# |
if [ "$enable_user32_GetSystemMetrics" -eq 1 ]; then
...
# |
if [ "$enable_user32_GetTipText" -eq 1 ]; then
...
# |
if [ "$enable_user32_Mouse_Message_Hwnd" -eq 1 ]; then
...
# |
if [ "$enable_user32_ScrollWindowEx" -eq 1 ]; then
...
# |
if [ "$enable_user32_WndProc" -eq 1 ]; then
...
# |
if [ "$enable_wineboot_HKEY_DYN_DATA" -eq 1 ]; then
...
# |
if [ "$enable_winebuild_LinkerVersion" -eq 1 ]; then
...
# |
if [ "$enable_wined3d_Revert_PixelFormat" -eq 1 ]; then
...
# |
if [ "$enable_winedevice_Fix_Relocation" -eq 1 ]; then
...
# |
if [ "$enable_winemenubuilder_Desktop_Icon_Path" -eq 1 ]; then
...
# |
if [ "$enable_winex11_CandidateWindowPos" -eq 1 ]; then
...
# |
if [ "$enable_winex11_Clipboard_HTML" -eq 1 ]; then
...
# |
if [ "$enable_winex11_Limited_Resolutions" -eq 1 ]; then
...
# |
if [ "$enable_winex11_Window_Groups" -eq 1 ]; then
...
# |
if [ "$enable_winex11_XEMBED" -eq 1 ]; then
...
# |
if [ "$enable_winex11_wglShareLists" -eq 1 ]; then
...
# |
if [ "$enable_wininet_FtpFindFirstFile" -eq 1 ]; then
...
# |
if [ "$enable_wininet_encoding" -eq 1 ]; then
...
# |
if [ "$enable_wpcap_Dynamic_Linking" -eq 1 ]; then
...
# |
if [ "$enable_ws2_32_Connect_Time" -eq 1 ]; then
...
# |
if [ "$enable_ws2_32_TransmitFile" -eq 1 ]; then
...
# |   *	dlls/ws2_32/socket.c, dlls/ws2_32/tests/sock.c
# |
if [ "$enable_ws2_32_getaddrinfo" -eq 1 ]; then
...
# |
if [ "$enable_wtsapi32_EnumerateProcesses" -eq 1 ]; then
